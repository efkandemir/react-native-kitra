...
| --- | --- | --- |  --- |
| onChange | ``(event: boolean) => void`` | No  | A function that is called when the radio button is pressed. The current value of the radio button is passed as an argument to the function. |
